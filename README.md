...
4. The chat title is automatically generated from your first message

### Using vision models

1. Select a model with the **eye icon** (vision-capable)
2. Click the **paperclip icon** to attach an image
...
| Edit title | Hover over the chat title → click the **pencil icon** |
| Delete chat | Hover over the chat in the sidebar → click **delete** |
